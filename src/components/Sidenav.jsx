        ...
        className='absolute top-4 right-5 z-[50] md:hidden '/>
        {
            nav ? (
                <div className='fixed w-full h-screen bg-white/50 flex flex-col justify-center items-center z-20 filter: blur(64px) ease-in duration-200'>
                    ...
                    <a href="#work" className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-red-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200'>
                        <GrProjects size={20} />
